...
export function ProductSearch({ products, onProductSelect, placeholder = "Rechercher un produit..." }: ProductSearchProps) {
  ...
  return (
    <>
      ...
      {(isOpen || showDropdown) && (
        <div className="fixed inset-0 bg-black bg-opacity-20 z-40" onClick={() => {
          setIsOpen(false);
          setShowDropdown(false);
        }} />
      )}
      ...
      <div className="relative" ref={dropdownRef}>
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 pr-16 relative z-50"
          />
          <div className="absolute right-1 top-1/2 transform -translate-y-1/2 flex items-center space-x-1 z-50">
        ...
        {(isOpen || showDropdown) && filteredProducts.length > 0 && (
          <Card className="absolute top-full left-0 right-0 mt-1 z-50 max-h-64 overflow-y-auto shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        ...
        {(isOpen || showDropdown) && searchTerm && filteredProducts.length === 0 && (
          <Card className="absolute top-full left-0 right-0 mt-1 z-50 shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
